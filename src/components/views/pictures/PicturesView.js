...
export class PicturesView extends BaseComponent {
  constructor(parentElement) {
    ...
    this.btnHome = new BaseComponent(this.picturesHead.element, "button", ["pictures_head__btnHome"], "", "home");
    ...
    this.btnScore = new BaseComponent(this.picturesHead.element, "button", ["pictures_head__btnScore"], "", "score");
    this.containerCategories = new BaseComponent(this.pictures.element, "div", ["pictures_categories"]);

    this.categories = Math.floor(SIZE_INPUT_ARRAY / NUMBER_QUESTIONS);
    arrCategories.map((item, index) => new CardElement(this.containerCategories, item, index));
  }
}
